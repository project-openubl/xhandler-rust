    ...
    let mut invoice = Invoice {
        detalles: vec![
            ...
            Detalle {
                ...
                isc_tasa: Some(dec!(0.17)),
                icb_aplica: true,
                igv_tipo: Some(Catalog7::GravadoRetiroPorPremio.code().into()),
                ..Default::default()
            },
        ],
        ..invoice_base()
    ...
    let mut invoice = Invoice {
        detalles: vec![
            ...
            Detalle {
                ...
                cantidad: dec!(2),
                precio: Some(dec!(100)),
                igv_tipo: Some(Catalog7::ExoneradoOperacionOnerosa.code().into()),
                isc_tipo: Some(Catalog8::SistemaAlValor.code().into()),
                isc_tasa: Some(dec!(0.10)),
                ..Default::default()
            },
            Detalle {
                descripcion: "Item4".into(),
                cantidad: dec!(2),
                precio: Some(dec!(100)),
                igv_tipo: Some(Catalog7::ExoneradoTransferenciaGratuita.code().into()),
                isc_tipo: Some(Catalog8::SistemaAlValor.code().into()),
                isc_tasa: Some(dec!(0.10)),
                ..Default::default()
            },
            Detalle {
                descripcion: "Item5".into(),
                cantidad: dec!(2),
                precio: Some(dec!(100)),
                igv_tipo: Some(Catalog7::InafectoOperacionOnerosa.code().into()),
                isc_tipo: Some(Catalog8::SistemaAlValor.code().into()),
                isc_tasa: Some(dec!(0.10)),
                ..Default::default()
            },
            Detalle {
                descripcion: "Item6".into(),
                cantidad: dec!(2),
                precio: Some(dec!(100)),
                igv_tipo: Some(Catalog7::InafectoRetiroPorBonificacion.code().into()),
                isc_tipo: Some(Catalog8::SistemaAlValor.code().into()),
                isc_tasa: Some(dec!(0.10)),
                ..Default::default()
            },
