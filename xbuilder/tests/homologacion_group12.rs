...
const BASE: &str = "tests/resources/e2e/homologacion/Group12Test";
...
async fn caso96_boleta1_con_3_items() {
    ...
    assert_invoice(&mut invoice, &format!("{BASE}/boleta1Con3Items.xml")).await;
}

// Case 97: Nota de Credito
