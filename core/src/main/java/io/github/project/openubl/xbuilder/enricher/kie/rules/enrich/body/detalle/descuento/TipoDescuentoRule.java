 ...
 */
package io.github.project.openubl.xbuilder.enricher.kie.rules.enrich.body.detalle.descuento;
    ...
    public void modify(Object object) {
        Consumer<Descuento> consumer = descuento -> {
            ...
            if (descuento.getTipoDescuento() == null) {
                tipoDescuento = Catalog53_DescuentoPorItem.DESCUENTO_NO_AFECTA_BASE_IMPONIBLE_IGV_IVAP.getCode();
            } else {
                Catalog53_DescuentoPorItem catalog53 = Catalog
                        .valueOfCode(Catalog53_DescuentoPorItem.class, descuento.getTipoDescuento())
