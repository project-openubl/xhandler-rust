...
public class InvoiceDescuentosPorLineaTest extends AbstractTest {

    @Test
    public void descuentoPorItem() throws Exception {
        // Given
        Invoice input = Invoice.builder()
                ...
                .detalle(DocumentoVentaDetalle.builder()
                        ...
                        .descuento(Descuento.builder()
                                ...
                                .tipoDescuento(Catalog53.DESCUENTO_AFECTA_BASE_IMPONIBLE_IGV_IVAP.getCode())
                                .build()
                        )
                        .build()
                )
        ...
        // Then
        XMLAssertUtils.assertSnapshot(xml, getClass(), "descuentoPorItem.xml");
