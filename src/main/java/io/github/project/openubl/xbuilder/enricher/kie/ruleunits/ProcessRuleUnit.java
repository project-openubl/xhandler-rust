...
public class ProcessRuleUnit implements RuleUnit {

    private final Defaults defaults;
    private final LocalDate localDate;
    private final List<RuleFactory> rules = RuleFactoryRegistry.getRuleFactories(RulePhase.PhaseType.PROCESS);

    public ProcessRuleUnit(Defaults defaults, LocalDate localDate) {
    ...
    public void modify(Object object) {
        ...
        do {
            ...
            rules.stream()
                    ...
                    .map(factory -> factory.create(defaults, localDate))
