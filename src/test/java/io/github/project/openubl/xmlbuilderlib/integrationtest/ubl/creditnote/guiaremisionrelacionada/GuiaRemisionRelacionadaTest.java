 ...
 */
package io.github.project.openubl.xmlbuilderlib.integrationtest.ubl.creditnote.guiaremisionrelacionada;
...
public class GuiaRemisionRelacionadaTest extends AbstractUBLTest {
    ...
    void testGuiaRemisionRemitente() throws Exception {
        ...
        assertSnapshot(xml, "xml/creditnote/guiaremisionrelacionada/guiaRemisionRemitente.xml");
        assertSendSunat(xml);
    }
    ...
    void testGuiaRemisionTransportista() throws Exception {
        ...
        // Then
        assertOutputHasNoConstraintViolations(validator, output);
        assertSnapshot(xml, "xml/creditnote/guiaremisionrelacionada/guiaRemisionTransportista.xml");
        assertSendSunat(xml);
    }
